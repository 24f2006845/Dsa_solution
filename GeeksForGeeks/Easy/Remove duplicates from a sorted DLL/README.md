...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/remove-duplicates-from-a-sorted-doubly-linked-list/1)

## Solved On
09 Sept 2026 at 01:37 pm

<h2><a href="https://www.geeksforgeeks.org/problems/remove-duplicates-from-a-sorted-doubly-linked-list/1">Remove duplicates from a sorted DLL</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given a doubly&nbsp;linked list of <strong>n </strong>nodes sorted by values, remove duplicate nodes present in the linked list.</span></p>
